    ...
    <div class="py-6" x-data="{ openPinjam: false, selectedBook: null, eksemplars: [] }">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-6">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-4">
                    ...
                    {{-- Pencarian --}}
                    <form method="GET" action="{{ route('siswa.books.index') }}" class="flex flex-wrap items-center gap-2">
                                ...
                                <td class="py-2 px-3 border">
                                    <button
                                        @click="
                                            ...
                                            fetch(`/siswa/books/${selectedBook}/eksemplar`)
                                                .then(res => res.json())
        ...
        <x-modal title="Pilih Eksemplar Buku" show="openPinjam">
            <template x-if="eksemplars.length > 0">
                <form :action="`/siswa/books/pinjam/${selectedBook}`" method="POST">
                    @csrf
                    <div class="mb-4">
