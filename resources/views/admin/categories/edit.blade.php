<x-app-layout>
    ...
    <div class="py-10 max-w-3xl mx-auto">
        <form action="{{ route('categories.update', $category) }}" method="POST"
            ...
            {{-- Input Deskripsi --}}
            <div class="mb-6">
                <label for="deskripsi" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Deskripsi</label>
                <textarea name="deskripsi" id="deskripsi" rows="4"
                    class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 p-3 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $category->deskripsi) }}</textarea>
            </div>
