    ...
    <tbody>
        @forelse ($loans as $item)
            <tr class="border-b">
                ...
                <td class="px-4 py-2">{{ $item->book->judul }}</td>
                <td class="px-4 py-2">{{ $item->tanggal_peminjaman?->format('Y-m-d') }}</td>
                <td class="px-4 py-2">{{ $item->tanggal_jatuh_tempo?->format('Y-m-d') }}</td>
                <td class="px-4 py-2">{{ $item->tanggal_pengembalian?->format('Y-m-d') ?? '-' }}</td>
                <td class="px-4 py-2">
